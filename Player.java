 ...
 */
 ...
 /*
public class Player extends JLabel implements LoadImage {
...
//        super.paintComponent(g);
//        Graphics2D pen = (Graphics2D) g;
//        int x1 = this.x - this.height / 2;
//        int y1 = this.y - this.width / 2;
////        int diameter = this.radius * 2;
//        pen.drawImage(player, x1, y1, null);
//        this.loadImage();
//    }
...
//    public void loadImage() {
//        try {
//           player = ImageIO.read(new File(this.imageFile));
//       } catch (IOException e) {
//       }
//    }
